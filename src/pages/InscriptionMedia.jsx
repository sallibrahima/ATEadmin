...
const InscriptionMedia = () => {
  ...
  const handlePhoneChange = (value, country) => {
    setFormData(prev => ({
      ...prev,
      telephone: value,
      pays: country.countryCode, // ex : "gn"
    }));
  };
  ...
  const handleSubmit = (e) => {
    ...
    // Ici, intégration Supabase ou autre back-end
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary via-purple-700 to-indigo-800 flex flex-col justify-center items-center p-4">
      ...
      >
        <div className="bg-card shadow-2xl rounded-xl p-8 md:p-10">
          ...
          <h1 className="text-3xl font-bold text-center text-foreground mb-2">Inscription Media</h1>
          <p className="text-muted-foreground text-center mb-8">Remplissez le formulaire pour vous inscrire.</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="nom" className="text-foreground">Nom du media</Label>
              <Input
                id="nom"
                name="nom"
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="prenom" className="text-foreground">Plateforme</Label>
              <Input
                id="prenom"
                name="prenom"
                type="text"
            ...
            {/* Nouveau champ description courte */}
                        <div className="space-y-2">
                          ...
                          {/* Upload logo startup */}
                          <div className="space-y-2">
                            <Label htmlFor="logoFile" className="text-foreground">Logo du media</Label>
                            <input
                              id="logoFile"
                              name="logoFile"
                              type="file"
...
export default InscriptionMedia;
